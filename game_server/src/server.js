const protocol = require('./global/protocol');
...
module.exports = (io, socket) => {
    ...
    const worldId = parseInt(socket.handshake.query.worldId, 10);

    if (isNaN(worldId)) // assuming IDs are only Integers
        return;
    ...
    socket.on(protocol.PING, (clientTime) => {
