...
Revision ID: c80638681af7
Revises: 
Create Date: 2021-04-12 16:48:41.436429
...
def upgrade():
    ...
    op.execute("create schema fastapi")
    op.create_table('tag',
    ...
    op.create_table('world_tag',
    sa.Column('world_id', sa.Integer(), nullable=False),
    sa.Column('tag_name', sa.String(length=30), nullable=False),
    sa.ForeignKeyConstraint(['tag_name'], ['fastapi.tag.name'], ),
    sa.ForeignKeyConstraint(['world_id'], ['fastapi.world.world_id'], ),
    sa.PrimaryKeyConstraint('world_id', 'tag_name'),
    schema='fastapi'
    )
...
def downgrade():
    ...
    op.drop_table('world_tag', schema='fastapi')
